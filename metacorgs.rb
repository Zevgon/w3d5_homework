...
class CorgiPerk2
  ...
  def method_missing(name, *args)
    name = name.to_s
    if ["bone", "kibble", "silly_outfit"].include?(name)
...
class CorgiPerk3
  ...
  def self.get_attribute_info(name)
  ...
  get_attribute_info(:bone)
  get_attribute_info(:kibble)
  get_attribute_info(:silly_outfit)
